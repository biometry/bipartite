...
\hlstd{igraph}\hlopt{::}\hlkwd{estimate_betweenness}\hlstd{(}\hlkwd{tnet_igraph}\hlstd{(SafPlantsEL),} \hlkwc{cutoff}\hlstd{=}\hlnum{9}\hlstd{)} \hlcom{# 6}
...
\hlstd{btws} \hlkwb{<-} \hlkwd{cbind}\hlstd{(}\hlstr{"t:betw"}\hlstd{=tnet}\hlopt{::}\hlkwd{betweenness_w}\hlstd{(SafPlantsEL)[,}\hlnum{2}\hlstd{],}
    ...
    \hlstr{"i:estbetw"}\hlstd{=igraph}\hlopt{::}\hlkwd{estimate_betweenness}\hlstd{(}\hlkwd{tnet_igraph}\hlstd{(SafPlantsEL),} \hlkwc{cutoff}\hlstd{=}\hlnum{9}\hlstd{),}
