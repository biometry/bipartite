plot2webs_v2 <- function(web1,
  ...
  } else if (length(lower_color) == 1) {
    lower_color_1 <- lower_color
    lower_color_2 <- lower_color
  } else if (length(lower_color) < nr) {
    warning("Length of lower_color vector does not match number of lower species.")
