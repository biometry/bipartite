...
for (i in 1:nrow(small1976)){
  for (j in 1:ncol(small1976)){
    small.long <- rbind(small.long, c(rownames(small1976)[i], colnames(small1976)[j], small1976[i, j]))
  }
}
write.csv(small.long[-1,], file="small1976long.csv", quote=F)
@
