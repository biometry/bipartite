...
`r knitr::opts_chunk$set(cache = FALSE, fig.align = 'center', dpi = 300, out.width = "100%")`
...
plotweb(Safariland, srt = 90, lower_labels = rep("abcdefghijklmnop", 9))
```
...
## Adding a bipartite plot to another plot