...
```{r, fig.width=10, fig.height=10}
source("~/bipartite/plot2webs_v2.R")
plot2webs_v2(web, web, horizontal = TRUE, add_upper_abundances = list(c("U1" = 5, "U2" = 5, "U3" = 10), c("U1" = 5, "U2" = 5, "U3" = 10)), scaling = "relative")
plot2webs_v2(web, web, horizontal = FALSE, add_upper_abundances = list(c("U1" = 5, "U2" = 5, "U3" = 10), c("U1" = 5, "U2" = 5, "U3" = 10)), scaling = "relative", plot_axes = TRUE, srt = 0)
```
